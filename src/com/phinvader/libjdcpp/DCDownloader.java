...
public class DCDownloader {
    ...
    /**
     * @param nick            - Nick to download from
     * @param s               - Socket connection
     * @param remote_filename - Path to the file on remote user, from where to be downloaded
     * @param local_filename  - Path where the downloaded file should be saved
     * @return
     */
    //
